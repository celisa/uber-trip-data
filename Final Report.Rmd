...
$$logit(\pi_{i}) = ln(\pi_{i}/1-\pi_{i}) = {\beta_0} + {\beta_1}Borough + {\beta_2}ubertrips +{\beta_3}trafficcol +{\beta_4}AWND +{\beta_5}rain  + {\beta_6}SNOW + {\beta_7}TAVG $$

```{r final_project, echo = FALSE, results = 'asis', message = FALSE, warning = FALSE, cache = TRUE}
...
```{r final_project2, echo = FALSE, results = 'asis', message = FALSE, warning = FALSE, cache = TRUE}
...
```{r final_project4, echo = FALSE, results = 'asis', message = FALSE, warning = FALSE, cache = TRUE}
...
```{r final_project5, echo = FALSE, results = 'asis', message = FALSE, warning = FALSE, cache = TRUE}
confusion_mat_1 <- matrix(c(578,0, 56, 0), nrow = 2, dimnames = list(c("Pred not killed", "Pred killed"), c("Not Killed", "Killed")))
par(mfrow=c(1,1))
...
confusion_mat_2 <- matrix(c(247,0, 24, 0), nrow = 2, dimnames = list(c("Pred not killed", "Pred killed"), c("Not Killed", "Killed")))
par(mfrow=c(1,1))
